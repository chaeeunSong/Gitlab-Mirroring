...
return array(
    ...
    'image_width'      => 388,       // width of captcha image in pixels
    'image_height'     => 50,       // height of captcha image in pixels
    'code_length'      => 6,         // # of characters for captcha code
    'image_bg_color'   => '#ddd',//'#ddd', // hex color for image background
    'text_color'       => '#333',//'#707070', // hex color for captcha text
    'line_color'       => '#909090', // hex color for lines over text
    ...
    'perturbation'     => 0.5,//0.1,       // distoration level

    'use_random_spaces'   => true,
    'use_random_baseline' => true,//true,
    'use_text_angles'     => true,//true,
