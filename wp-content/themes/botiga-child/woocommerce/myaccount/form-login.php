...
<style>
    ...
    .woocommerce-account .woocommerce-form-login{padding:60px 60px 0 60px; min-height:auto;}
    .woocommerce-account .woocommerce-form-register{padding:0px 60px 0 60px; min-height:auto;}
...
<div class="u-columns col2-set" id="customer_login">
    ...
    <div class="u-column1 col-1">
        ...
        <form class="woocommerce-form woocommerce-form-login login" method="post">
            ...
            <p class="login_tit_txt"><b>로그인 및 회원가입</b>을 시작합니다</p>
            ...
            <div class="email_login">
                <div class="email_login_tit">이메일로 시작합니다 <i class="fa-solid fa-circle-check"></i></div>
                <div class="email_login_form">
        ...
        <div class="register_con">
            <div class="register_con_tit">회원가입 하시려면 <i class="fa-solid fa-circle-check"></i></div>
            <div class="register_con_wrap">
...
<script>
    $('.email_login_tit').click(function(){
        $('.email_login_form').slideToggle();
    });

    $('.register_con_tit').click(function(){
        $('.register_con_wrap').slideToggle();
    });

    $('.email_login_tit').click(function(){
        $('.email_login_tit').toggleClass('icon_act');
    });

    $('.register_con_tit').click(function(){
        $('.register_con_tit').toggleClass('icon_act');
    });
</script>