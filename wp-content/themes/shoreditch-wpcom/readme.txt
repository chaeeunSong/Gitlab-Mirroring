...
= 3 May 2018 =
* Adjust colour styles on the select dropdowns in the top menu area. The original styles resulted in white text on a white background in several Windows browsers.

= 5 April 2018 =
* Optimize images

= 7 March 2018 =
* Improvements to spacing in contact forms.
